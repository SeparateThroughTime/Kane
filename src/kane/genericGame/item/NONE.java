...
public class NONE extends Item {
	...
	private static final Sprite[] PLAYER_SPRITES = { new Sprite(new File("sprites\\player\\playerHead.png"), 2, 2),
			new Sprite(new File("sprites\\player\\playerUpper.png"), 2, 2),
