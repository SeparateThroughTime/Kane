...
public class LineBatch{
    ...
    private final static int ELEMENTS_PER_RENDER_OBJECT = 2;
    ...
    public void render(){
        ...
        glDrawElements(GL_LINES, this.numShapes * ELEMENTS_PER_RENDER_OBJECT, GL_UNSIGNED_INT, 0);
    ...
    private void loadInvisibleProperties(int shapeIndex){
        int offset = shapeIndex * ELEMENTS_PER_RENDER_OBJECT * VERTEX_SIZE;
    ...
    private int[] generateIndices(){
        int[] elements = new int[ELEMENTS_PER_RENDER_OBJECT * maxBatchSize];
    ...
    private void loadElementIndices(int[] elements, int index){
        int offsetArrayIndex = ELEMENT_SIZE * ELEMENTS_PER_RENDER_OBJECT * index;
